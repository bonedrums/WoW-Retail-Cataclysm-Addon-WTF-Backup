...
selected_directory = ""  # Ensure selected_directory is defined
...
def backup_process(root):
    ...
    # Add directories based on checkbox states
    if retail_toggle.get():
        if addons_toggle.get():
            selected_dirs.append(r"C:\Program Files (x86)\World of Warcraft\_retail_\Interface\AddOns")
        if wtf_toggle.get():
            selected_dirs.append(r"C:\Program Files (x86)\World of Warcraft\_retail_\WTF")
    elif cataclysm_toggle.get():
        if addons_toggle.get():
            selected_dirs.append(r"C:\Program Files (x86)\World of Warcraft\_classic_\Interface\AddOns")  # Corrected Cataclysm AddOns path
        if wtf_toggle.get():
            selected_dirs.append(r"C:\Program Files (x86)\World of Warcraft\_classic_\WTF")  # Ensure correct WTF path for Cataclysm
    else:
...
def create_gui():
    ...
    img = Image.open(r"E:\Nextcloud\Code\WOW\Addons Mover\icon.webp")
